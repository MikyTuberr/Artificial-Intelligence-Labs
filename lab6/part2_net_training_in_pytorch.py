...
def training(model, x, y):
    ...
    for epoch in range(1, epochs):
        ...
        y = y[indices]
        i_step = 0
        num_batches = x.size(0) // minibatch_size
        for batch_idx in range(num_batches):
            ...
            end_idx = minibatch_size + start_idx
            ...
            loss = loss_fn(forward_pass, y_batch)
            ...
            i_step += 1
            if i_step % num_batches == 0:
                print(f'Epoch={epoch}, Step={i_step}, lr={learning_rate:.6f}, loss={loss.item():.6f}')
...
if __name__ == '__main__':
    ...
    student_id = 193630         # Twój numer indeksu, np. 102247
